...
LORA_MODEL_PATH = f"path/to/models/Gen/{model_name}/TSP/epoch-4.safetensors"
INPUT_DIR = f"path/to/data/DiffThinker/TSP/{LEVEL}_test"
...
def gpu_worker(gpu_id, file_chunk):
    ...
    prompt = "Connect all points with red line segments to form the shortest closed loop."
